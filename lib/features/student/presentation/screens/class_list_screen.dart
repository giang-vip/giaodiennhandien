...
class _ClassListScreenState extends State<ClassListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      if (!mounted) return;
      await context.read<ClassListViewModel>().fetchAvailableClasses();
    });
  }
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: viewModel.isLoading ? null : _reload,
          ),
        ],
      ),
      body: viewModel.isLoading
        ...
        child: classes.isEmpty
          ...
          itemBuilder: (context, index) {
            ...
            final capacityText =
            viewModel.getCapacityText(item.id);
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: viewModel.isLoading || isFull
                          ...
                          final success =
                          await vm.registerClass(item.id);

                          if (!mounted) return;

                          if (success) {
                            _showTopNotification(
                              vm.lastActionMessage,
                              Colors.green,
                              Icons.check_circle,
                            );
                            ...
                            _showTopNotification(
                              vm.lastActionMessage.isNotEmpty
                                  ? vm.lastActionMessage
